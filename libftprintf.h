...
/*   Updated: 2020/02/14 23:13:01 by mokellat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_zero_d(va_list ap, t_flagcheck flags, int p);
...
void			ft_printf_p(const char *ptr, va_list ap, t_flagcheck flags);
...
void			ft_zero_p(va_list ap, t_flagcheck flags, unsigned long p);
...
void			ft_numbers_u(va_list ap, t_flagcheck flags, unsigned int p);
