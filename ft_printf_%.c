...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/02/11 18:21:24 by mokellat          #+#    #+#             */
/*   Updated: 2020/02/11 21:05:30 by mokellat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libftprintf.h"

void    ft_s_check_per(flagcheck flags)
{
    if(flags.zero == 1 && flags.negative == 0 && (flags.width > 1 || flags.numbers > 1))
        s = 2;
...
void    ft_print_help_per(int replace, flagcheck flags)
{
    if(s == 1)
    {
